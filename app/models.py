...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    sex = models.CharField(_('Gender'), max_length=30, blank=False, choices=choices)
    ...
    user_choices = (('Pilot', 'Pilot'), ('Passenger', 'Passenger'))
...
class VehicleSharing(models.Model):
    ...
    pickuppoint = models.CharField( max_length=256, blank=False)
