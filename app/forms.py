...
class CustomUserCreationForm(forms.ModelForm):
    ...
    user_type = forms.ChoiceField(choices=(('Pilot', 'Pilot'), ('Passenger', 'Passenger')))


    class Meta:
        # Point to our CustomUser here instead of default `User`
        model = CustomUser
        fields = ('full_name', 'short_name', 'email', 'gender', 'phone_number', 'user_type', 'address', 'username')
...
class VehicleShare(forms.ModelForm):
    ...
    pickuppoint = forms.CharField(widget=forms.TextInput(attrs={'required': True,'class':'form-control'}))  
    ...
    class Meta:
        ...
        fields = ['start', 'dest','pickuppoint','cost', 'date', 'start_time', 'arrival_time', 'no_pass','details', 'sex']
